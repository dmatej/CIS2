...
public class CodesBean implements Serializable {
    ...
    private HashMap<Integer, CodeState> states;

    private HashMap<Integer, CodePurposeofstay> purposesofstay;

    private HashMap<Integer, CodePermissiontype> permissiontypes;

    private HashMap<Integer, CodeDocumenttype> documenttypes;
